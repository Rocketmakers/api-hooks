...
export namespace EndpointIDs {
   ...
   * @param cacheKeyValue (optional) The value used to cache data against. Allows a specific state slice to be identified within an endpoint's cache, overrides cacheKeyFromMutationParam
   * @param cacheKeyFromMutationParam (optional) Allows the above cacheKeyValue to be derived from the parameter of a mutation.
   */
   ...
   * Contains everything passed into config as well as:
   * @param endpointHash The string used to identify the endpoint in global state.
   */
